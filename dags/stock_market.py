...
@dag(
    ...
    on_success_callback=SlackNotifier(
        slack_conn_id='slack',
        text='The DAG stock_market has succedded',
        channel='self'
    ),
...
def stock_market():
    ...
    def is_api_available() -> PokeReturnValue:
        ...
        print(f'POKE RETURN VALUE: {PokeReturnValue(is_done=condition, xcom_value=url)}')
    ...
    load_to_dw = aql.load_file(
        task_id='load_to_dw',
        # os dois {{}} adicionados ao path foram colocados em decorrência de estar sendo utilizado 
        #   f-string, caso contrário os mesmos não seriam reconhecidos
        input_file=File(
